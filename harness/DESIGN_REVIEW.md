...
The v6 specification resolves the API and rules questions:
...
3. Whether a preflop-equity cache should persist between matches.
4. Which uncertainty-aware model eventually replaces the placeholder Elo rule.
