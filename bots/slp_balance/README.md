...
free, call an opening bet 67%, and fold if their own bet is raised. Board-only
two pair is treated like air. Live draws also call an opening bet 67% and call
a raise 33%. With air, independent per-decision randomness chooses bet or
check with equal probability when action is free and always folds to
aggression.
