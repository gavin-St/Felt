...
const PATHS: Record<GlyphName, React.ReactNode> = {
  ...
  // better-all-in — a rising peak
  peak: <path d="M12 3l9 18H3z" />,
  // solved-all-in — a target
  target: (
    <>
  ...
  // slp-fold — a shield: it only ever defends
  shield: (
  ...
  // slp-bluff — a flame: every miss is a bet
  flame: (
  ...
  // slp-balance — a fork: the same hand goes two ways
  split: (
    <>
  ...
  // slp-exploit-fold — a key: built to open one specific lock
  key: (
  ...
  seat: (
    <>
      ...
      <path d="M3.6 21.4c0-4.5 3.8-7.4 8.4-7.4s8.4 2.9 8.4 7.4z" />
    </>
  ),
  // slp-exploit-solved — a probe: enters every pot to find the edge
  probe: (
    <>
